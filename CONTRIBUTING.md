...
```
$ git clone git@github.com:RchrdAriza/RetroPod.git
```
...
Please open [a new issue in the GitHub repository](https://github.com/RchrdAriza/RetroPod/issues) with steps to reproduce the problem you're experiencing.
